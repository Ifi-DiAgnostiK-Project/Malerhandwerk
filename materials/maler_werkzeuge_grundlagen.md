...
![Malerwerkzeug](../assets/img/malerrollen_fensterbrett.jpg "[_Quelle: Pixabay, stux_](https://pixabay.com/photos/renovate-painting-work-painting-1186334/)")
...
![Drei Pinseltypen nebeneinander: Flächenpinsel, Ringpinsel, Heizkörperpinsel](../assets/img/pinseltypen-vergleich.jpg "[_KI-generiert, DiAgnostiK_]")
...
![Schrägstrichzieher — zu erkennen an den langen, schräg geschnittenen Borsten](../assets/img/kleiner_pinsel.jpg "[_Quelle: HWK Dresden, Florian Riefling_]")
...
![Schrägstrichzieher mit Lineal in Aktion — gerade Linie an Farbflächenkante](../assets/img/strichzieher-lineal.jpg "[_KI-generiert, DiAgnostiK_]")
...
![Malerrolle](../assets/img/malerrolle.jpg "[_Quelle: HWK Dresden_]")<!-- style="max-width: 400px; width: 100%" -->
...
![Malerspachtel](../assets/img/spachtel.jpg "[_Quelle: HWK Dresden_]")<!-- style="max-width: 400px; width: 100%" -->
...
![Flächenrakel im Einsatz — Spachtelmasse wird gleichmäßig über eine Wandfläche abgezogen](../assets/img/flaechenrakel-wand.jpg "[_KI-generiert, DiAgnostiK_]")
...
![Tapezierbürste — breit, flach, gleichmäßig lange weiche Borsten](../assets/img/buerste.jpg "[_Quelle: HWK Dresden, Florian Riefling_]")<!-- style="max-width: 300px; width: 100%" -->
